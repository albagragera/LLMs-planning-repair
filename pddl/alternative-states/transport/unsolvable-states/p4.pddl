; Transport city-sequential-4nodes-1000size-3degree-100mindistance-2trucks-2packages-2012seed

(define (problem transport-city-sequential-4nodes-1000size-3degree-100mindistance-2trucks-2packages-2012seed)
 (:domain transport)
 (:objects
  city-loc-1 - location
  city-loc-2 - location
